...
const TextInputAadhar = (props) => {
  ...
  const[OtpInput,setShowOtpInput] = useState(true);
  ...
  useEffect(() => {
    if (verifyAadharData) {
      ...
      setShowLoading(false)
      setError(true)
      setMessage(verifyAadharError?.data?.Error?.message ? verifyAadharError?.data?.Error?.message : "Wrong OTP")
  ...
  return (
    <View style={{ alignItems: "center", justifyContent: "center", width: '100%' }}>
      ...
      <View style={{ height: 60, width: '86%', borderWidth: 1, borderColor: '#DDDDDD', alignItems: "center", justifyContent: "center", backgroundColor: 'white', margin: 10, flexDirection: 'row' }}>
        ...
        {sendAadharOtpIsLoading && <FastImage
      ...
      {showOtp && OtpInput && <View style={{ height: 60, width: '86%', borderWidth: 1, borderColor: '#DDDDDD', alignItems: "center", justifyContent: "center", backgroundColor: 'white', margin: 10 }}>
